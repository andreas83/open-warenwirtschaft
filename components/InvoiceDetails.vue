  ...
  <div class="space-y-6">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div>
        ...
        <input id="rechnungsnummer" v-model="rechnung.Rechnungsnummer" type="text" class="w-full border border-gray-200 dark:border-gray-600 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100" :required="mode === 'edit'">
      </div>
      <div>
    ...
    <div>
      ...
      <textarea id="rechnungsadresse" v-model="rechnung.Rechnungsadresse" rows="3" class="w-full border border-gray-200 dark:border-gray-600 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"></textarea>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div>
        <label for="zahlungsstatus" class="block text-gray-700 dark:text-gray-300 font-medium mb-2">Zahlungsstatus</label>
        <select id="zahlungsstatus" v-model="rechnung.Zahlungsstatus" class="w-full border border-gray-200 dark:border-gray-600 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
      ...
      <div>
        ...
        <input id="waehrung" v-model="rechnung.Waehrung" type="text" class="w-full border border-gray-200 dark:border-gray-600 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100" placeholder="z.B. EUR" required>
      </div>
    </div>
    <div>
      <label for="kommentare" class="block text-gray-700 dark:text-gray-300 font-medium mb-2">Kommentare</label>
      <textarea id="kommentare" v-model="rechnung.Kommentare" rows="3" class="w-full border border-gray-200 dark:border-gray-600 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"></textarea>
    </div>
  </div>
</template>
