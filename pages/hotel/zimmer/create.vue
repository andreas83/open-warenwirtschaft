  ...
  <div class="p-6">
    <div class="max-w-3xl mx-auto">
      ...
      <div class="bg-white rounded-lg shadow-md p-6">
        <h1 class="text-2xl font-bold text-gray-800 mb-2">{{ t('hotel.rooms.newRoom') }}</h1>
        <p class="text-gray-600 mb-6">{{ t('hotel.rooms.createSubtitle') }}</p>
        ...
        <form @submit.prevent="saveRoom" class="space-y-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                :placeholder="t('hotel.rooms.roomNumberPlaceholder', '101')"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                type="number"
                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                :placeholder="t('hotel.rooms.floorPlaceholder', '1')"
              />
            </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows="3"
              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
              :placeholder="t('hotel.rooms.descriptionPlaceholder', 'Beschreiben Sie das Zimmer...')"
            ></textarea>
          </div>
