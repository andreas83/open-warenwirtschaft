<template>
  <div class="p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      <NuxtLink
        to="/hotel/buchungen"
        class="bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg shadow-md p-6 transition duration-200 flex items-center justify-between"
      >
        <div>
          <h3 class="text-xl font-semibold mb-2">{{ t('hotel.dashboard.bookings') }}</h3>
          <p class="text-indigo-100">{{ t('hotel.dashboard.manageBookings') }}</p>
        </div>
