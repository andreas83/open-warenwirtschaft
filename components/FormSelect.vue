<template>
  <div class="mb-4">
    ...
    <div class="relative">
      ...
      >
        <div v-if="errorMessage" class="i-mdi-alert-circle text-red-500 w-5 h-5" />
        <div v-else class="i-mdi-chevron-down text-gray-400 w-5 h-5" />
      </div>
    </div>
    <p
...
const handleChange = (e: Event) => {
  ...
  if (touched.value && props.validator) {
    localError.value = props.validator(finalValue)
  }
}
